    ...
    <div className="min-h-screen bg-white text-black pb-20">
      ...
      <div className="px-4 mb-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="px-4 py-1 bg-yellow-600 hover:bg-yellow-700 rounded-full text-sm font-medium text-white transition-colors">
            换本词书
          </button>
        </div>
        ...
        <div className="bg-gray-100 rounded-2xl p-4 border border-gray-300">
          <div className="flex gap-4">
            {/* 词书封面 */}
            <div className="w-24 h-32 bg-gradient-to-br from-orange-400 to-orange-500 rounded-xl flex flex-col items-center justify-center text-white flex-shrink-0">
              <div className="text-sm font-bold mb-2">
                {learningData.currentBook}
              </div>
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-4">
                <div className="text-sm text-gray-600">配套真题词组</div>
              ...
              {/* 添加词组按钮 */}
              <div className="w-full h-20 border-2 border-dashed border-gray-300 rounded-xl flex items-center justify-center mb-3 hover:border-gray-400 transition-colors cursor-pointer">
          ...
          <div className="mt-4">
            ...
            <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${
                    (learningData.studiedWords / learningData.totalWords) * 100
                  }%`,
                }}
              />
            </div>
      ...
      <div className="px-4 mb-6">
        ...
        {/* 概览卡片 */}
        <button className="w-full bg-gray-100 rounded-2xl p-4 border border-gray-300 mb-3 hover:bg-gray-200 transition-all">
          <div className="flex items-center justify-between mb-4">
            <span className="text-sm text-gray-700">概览</span>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="text-2xl font-bold">
                {learningData.todayStudy}{" "}
                <span className="text-sm text-gray-600">词</span>
              </div>
            </div>
        ...
        <div className="bg-gray-100 rounded-2xl p-4 border border-gray-300">
          <div className="flex items-center justify-between mb-4">
            <span className="text-sm text-gray-700">日历</span>
